...
<div style="overflow: hidden;">
    <div class="row ">
        <div class="col-md-12  "><img class="header-img" style="width: inherit;"
            ...
            <div class="centered most-used-head">Stručni suradnik za BMC Software (m/ž)</div>
        </div>
    </div>
    ...
    <div class="row ">
        ...
        <div class="col-md-8 col-lg-5 col-sm-12 col-xl-5">
            <div class="most-used-par2 " style="text-align: left; padding-top:15%;color:#000000;font-size: 36px;font-weight:400;">
                Tražimo novu osobu na poziciji <b>Stručni suradnik za BMC Software <br>(m/ž) </b><br><br></div>
            <hr class="programming-border"><br>
            
            <div class="it-par">
                <p>
                    <br>
IMAVES d.o.o. je IT tvrtka sa sjedištem u Zagrebu za pružanje podrške korisnicima pri odabiru, projektiranju, uvođenju, održavanju i korištenju alata neophodnih za raspoloživost poslovnog sustava te zastupnik američke kompanije BMC Software.
                </p> <br>
            </div>
            <hr class="programming-border"><br>
            ...
            <div class="it-par">
                <p>
                    ...
                    <span style="font-weight:  500;">Što ćeš raditi:</span><br>
                          <ul>                   
                               <li>izučavanje IT proizvoda (BMC Software)</li>
                ...
                <p>
                    ...
                    <span style="font-weight:  500;">Vidimo te u Imaves-u ako imaš sljedeća znanja i kompetencije:</span><br>
                                <ul>
                                    ...
                                    <li>osnovna znanja programiranja (Javascript, Python)</li>
