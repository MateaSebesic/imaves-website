...
<div style="overflow: hidden;padding-bottom:10%;">
    <div class="row ">
        <div class="col-md-12  ">
            <div class="about-head">CODE OF ETHICS</div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-lg-4 col-6  "><br>
            <p class="about-par"><a class="most-used-link" href="assets/pdfs/PoveljaKodeksEtike.pdf" target="_blank">IMAVES Code of Ethics</a></p>
        </div>
