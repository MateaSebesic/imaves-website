...
<div style="overflow: hidden;">
    <div class="row ">
        <div class="col-md-12  "><img class="header-img" style="width: inherit;"
            ...
            <div class="centered most-used-head">Informatičar (m/ž)</div>
        </div>
    </div>
    ...
    <div class="row ">
        ...
        <div class="col-md-8 col-lg-5 col-sm-12 col-xl-5">
            <div class="most-used-par2 " style="text-align: left; padding-top:15%;color:#000000;font-size: 36px;font-weight:400;">
                Tražimo novu osobu na poziciji <b>Informatičar <br>(m/ž) </b><br><br></div>
            ...
            <div class="it-par">
                <p>
                    ...
                    <span style="font-weight:  500;">Što ćeš raditi:</span><br>
                          <ul>                   
                               <li>izučavanje IT proizvoda zahtjeva korisnika</li>
                               <li>instalacija, prilagodba i održavanje IT proizvoda kod korisnika</li>
                               <li>izučavanje poslovnih procesa</li>
                ...
                <p>
                    ...
                    <span style="font-weight:  500;">Vidimo te u Imaves-u ako imaš sljedeća znanja i kompetencije:</span><br>
                                <ul>
                                    <li>MS Windows okolina (klijent/poslužitelj) i Linux</li>
                                    <li>osnovna znanja o bazama podataka (MS SQL)</li>
                                    <li>poznavanje MS Azure rješenja</li>
                                    <li>poznavanje VMware virtualno okruženja</li>
...
Radno mjesto nudi mogućnost stjecanja dodatnih znanja, profesionalni napredak i razvoj te svoje interese, ambicije i talente možeš dodatno ostvariti.<br><br>
Radna atmosfera je opuštena i kreativna.<br><br>
Pozivamo zainteresirane kandidate da se prijave na natječaj slanjem životopisa i motivacijskog pisma. Kandidati koji uđu u uži krug bit će kontaktirani.
