...
/**
 * This is the model class for table "novost_prijevod".
 *
 * The followings are the available columns in table 'novost_prijevod':
 * @property integer $id
 ...
 * @property Novost $idNovost
 */
class NovostPrijevod extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return NovostPrijevod the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('id_novost, id_jezik, naslov, sadrzaj, seo_naslov, seo_opis, seo_kljucne_rijeci', 'required'),
			array('id_novost, id_jezik', 'numerical', 'integerOnly'=>true),
			...
			array('id, id_novost, id_jezik, naslov, podnaslov, sadrzaj, seo_naslov, seo_opis, seo_kljucne_rijeci', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'idNovost' => array(self::BELONGS_TO, 'Novost', 'id_novost'),
		);
	}
