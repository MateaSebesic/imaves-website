 ...
 *
 * The followings are the available columns in table 'novost':
 * @property integer $id
 ...
 * @property NovostPrijevod[] $novostPrijevods
 */
class Novost extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Novost the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'novostPrijevods' => array(self::HAS_MANY, 'NovostPrijevod', 'id_novost'),
		);
	}
