...
Polja označena z zvezdico  (<span style="color:orange;">*</span>) obavezno je ispuniti! </h5>
...
<div class="md-form form-group mt-5 form-padding">
  ...
  <label for="inputPlaceholderEx" class="unregistered-par2">Priimek<span style="color:orange;">*</span></label>
  <input placeholder="" type="text" name="surname" id="inputPlaceholderEx" class="form-control form-control-contact" required>
  <label for="inputPlaceholderEx" class="unregistered-par2">Podjetje</label>
  ...
  <label for="inputPlaceholderEx" class="unregistered-par2">Naslov elektronske pošte (email)<span style="color:orange;">*</span></label>
  <input placeholder="" type="text" name="email" id="inputPlaceholderEx" class="form-control form-control-contact" required>
  <label for="inputPlaceholderEx" class="unregistered-par2">Vprašanje ali komentar<span style="color:orange;">*</span></label>
  ...
  <input class=" registered-button registered-button-text btnr " type="submit" style = "border: none;"  value="Pošlji" placeholder="">
</div>
