...
<div style="overflow: hidden;">
    <div class="row ">
        <div class="col-md-12  "><img class="header-img" style="width: inherit;"
            ...
            <div class="centered most-used-head">Stručni suradnik za 4me (m/ž)</div>
        </div>
    </div>
    ...
    <div class="row ">
        ...
        <div class="col-md-8 col-lg-5 col-sm-12 col-xl-5">
            <div class="most-used-par2 " style="text-align: left; padding-top:15%;color:#000000;font-size: 36px;font-weight:400;">
                Tražimo osobu na poziciji <b>Stručni suradnik za 4me <br>(m/ž) </b><br><br></div>
            <hr class="programming-border"><br>

            <div class="it-par">
                <p>
                    <br>
IMAVES d.o.o. je IT tvrtka sa sjedištem u Zagrebu za pružanje podrške korisnicima pri odabiru, projektiranju, uvođenju, održavanju i korištenju alata neophodnih za raspoloživost poslovnog sustava te zastupnik američke kompanije 4me.
                </p> <br>
            </div>
            <hr class="programming-border"><br>
            ...
            <div class="it-par">
                <p>
                    <br>
Stručni suradnik za implementaciju upravljanja uslugama je majstor za sve; uključen u prodajne procese, projekte, održavanje funkcionalnosti i pružanje podrške za isporučena rješenja. Projekte ćeš raditi s kolegama i korisničkim timom kako biste razgovarali o uslugama koje treba isporučiti te tijekovima procesa i zajedno ćete biti odgovorni za njihovu realizaciju. Usko ćeš surađivati s drugima u projektu, ali možeš raditi i samostalno.<br>
                </p> <br>
            </div>
            ...
            <div class="it-par">
                <p>
                    ...
                    <span style="font-weight:  500;">Glavne karateristike posla bile bi:</span><br>
                       <ul>
                            <li>izučavanje IT proizvoda (4me)</li>
                            <li>implementacija, prilagodba i održavanje IT proizvoda kod korisnika</li>
                            <li>izučavanje ITIL poslovnih procesa</li>
                       </ul>
                </p> <br>
                <p>
                    <br>
                    <span style="font-weight:  500;">Vidimo te u Imaves-u ako imaš sljedeća znanja i kompetencije:</span><br>
                                <ul>
                                    ...
                                    <li>napredno poznavanje MS Windows okoline (klijent/poslužitelj) i Linux-a</li>
                                    <li>osnovna znanja programiranja (HTML/CSS, Javascript, Python)</li>
